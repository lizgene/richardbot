...
module.exports = (robot) ->
  ...
  # Had to override help function in hubot
  ...
  robot.hear /how do i/i, (msg) ->
    message = "
      ...
      richard add [me|username]\n
        \tAdd yourself to the exercise channel! You'll be added to our default fitness group to start.\n
      richard remove [me|username]\n
